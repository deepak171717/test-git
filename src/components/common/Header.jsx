...
import GB_flag from '../../images/flag/GB.png';
import German_flag from '../../images/flag/DE.png';
import French_flag from '../../images/flag/FR.png';
import Italian_flag from '../../images/flag/IT.png';
import Russian_flag from '../../images/flag/RU.png';
import QRCODE from '../../images/qr-code.png'

import userProfileImg from '../../images/profile_av.svg'
          ...
          <div className="container-xxl">
            ...
            <div className="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                          ...
                          <li className="py-2 mb-1 border-bottom">
                            <Link to="#" className="d-flex">
                              ...
                              <div className="flex-fill ms-2">
                                ...
                                <span className>Low Activity</span>
                              </div>
                            </Link>
                          </li>
                          <li className="py-2 mb-1 border-bottom">
                            <Link to="#" className="d-flex">
                              ...
                              <div className="flex-fill ms-2">
                                ...
                                <span className>New Task Toyseller</span>
                              </div>
                            </Link>
                          </li>
                          <li className="py-2 mb-1 border-bottom">
                          ...
                          <li className="py-2">
                            <Link to="#" className="d-flex">
                              ...
                              <div className="flex-fill ms-2">
                                ...
                                <span className>Profile Updated</span>
                              </div>
                            </Link>
                          </li>
                        </ul>
                ...
                <div className="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-md-end p-0 m-0">
                  <div className="card border-0">
                    <ul className="list-unstyled py-2 px-3">
                      <li>
                        <Link to="#" className><img src={GB_flag} alt="" /> English</Link>
                      </li>
                      <li>
                        <Link to="#" className><img src={German_flag} alt="" /> German</Link>
                      </li>
                      <li>
                        <Link to="#" className><img src={French_flag} alt="" /> French</Link>
                      </li>
                      <li>
                        <Link to="#" className><img src={Italian_flag} alt="" /> Italian</Link>
                      </li>
                      <li>
                        <Link to="#" className><img src={Russian_flag} alt="" /> Russian</Link>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center">
                <Link className="nav-link dropdown-toggle pulse p-0" to="#" role="button" data-bs-toggle="dropdown" data-bs-display="static">
                  <img className="avatar lg rounded-circle img-thumbnail" src={userProfileImg} alt="profile" />
                </Link>
                <div className="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                  <div className="card border-0 w280">
                    <div className="card-body pb-0">
                      <div className="d-flex py-1">
                        <img className="avatar rounded-circle" src={userProfileImg} alt="profile" />
                    ...
                    <div className="list-group m-2 ">
                     ...
                     <Link to="profile.html" className="list-group-item list-group-item-action border-0">
                      ...
                      <Link to="security.html" className="list-group-item list-group-item-action border-0 ">
                      ...
                      <Link to="tracker-setting.html" className="list-group-item list-group-item-action border-0 ">
                      ...
                      <Link to="ui-elements/auth-signin.html" className="list-group-item list-group-item-action border-0 ">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24" className="me-3">
            ...
            <div className="order-0 col-lg-4 col-md-6 col-sm-12 col-12 mb-3 mb-md-0 d-flex align-items-center">
              ...
              <Link className="menu-toggle-option me-3 text-primary d-flex align-items-center" to="#" title="Menu Option">
                ...
                <div className="card border-0 shadow rounded-3 search-result slidedown">
                  <div className="card-body text-start">
                    ...
                    <div className="dropdown-item bg-transparent text-wrap my-2">
                      <Link className="badge bg-primary" to="#">Pixelwibes <i className="fa fa-search ms-1" /></Link>
                      <Link className="badge bg-primary" to="#">Theme <i className="fa fa-search ms-1" /></Link>
                      <Link className="badge bg-primary" to="#">Tracker <i className="fa fa-search ms-1" /></Link>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-lg-10">
                      <ul className="menu-grid list-unstyled row row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 g-4 mb-0 mt-lg-3">
                        <li className="col">
                          <Link to="help.html" className="d-flex color-700">
                            <div className="avatar">
                              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 38 38">
                                <circle xmlns="http://www.w3.org/2000/svg" cx={19} cy={19} r={11} style={{fill: 'var(--primary-color)'}} data-st="fill:var(--chart-color4);" />
                        ...
                        <li className="col">
                          <Link to="ui-elements/ui-alerts.html" className="d-flex color-700">
                            <div className="avatar">
                              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24">
                                <rect xmlns="http://www.w3.org/2000/svg" className="st2" width={24} height={24} style={{fill: 'none'}} fill="none" />
                                <path xmlns="http://www.w3.org/2000/svg" d="M13,1.07V9h7C20,4.92,16.95,1.56,13,1.07z M4,15c0,4.42,3.58,8,8,8s8-3.58,8-8v-4H4V15z   M11,1.07C7.05,1.56,4,4.92,4,9h7V1.07z" style={{fill: 'var(--primary-color)'}} data-st="fill:var(--chart-color4);" />
                                <path xmlns="http://www.w3.org/2000/svg" className="st0" d="M13,1.07V9h7C20,4.92,16.95,1.56,13,1.07z M11,1.07C7.05,1.56,4,4.92,4,9h7V1.07z" style={{opacity: '0.2', fill: '#FFFFFF'}} fill="rgb(255, 255, 255)" />
                                <path xmlns="http://www.w3.org/2000/svg" className="st0" d="M6,15c-1.66,0-2.491,0.82-2.941,2.418C2.628,18.939,2.625,19.625,1,20.407C1.92,21.38,3.49,22,5,22  c2.21,0,4-1.563,4-3.719C9,16.389,7.66,15,6,15z M21.49,5C20,7,17.96,10.04,16,12c-1.48,1.48-5.48,3.93-5.48,3.93L8.07,13.48  c0,0,2.45-4,3.93-5.48c1.96-1.96,5-4,7-5.48c0.78-0.58,1.8-0.69,2.49,0C22.17,3.2,22.06,4.22,21.49,5z" />
                                <path xmlns="http://www.w3.org/2000/svg" className="st0" d="M16,12c-1.479,1.48-5.477,3.927-5.477,3.927l-2.449-2.45c0,0,2.445-3.998,3.926-5.477L16,12z" />
                              </svg>
                            </div>
                            <div className="flex-fill text-truncate">
                        ...
                        <li className="col">
                          <Link to="invoices.html" className="d-flex color-700">
                            <div className="avatar">
                              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 38 38">
                                <path xmlns="http://www.w3.org/2000/svg" d="M22,6h2c0.875,0,1.513,0.657,2,1.31V10h4.501L32,12v24H22V6z" style={{fill: 'var(--primary-color)'}} data-st="fill:var(--chart-color4);" />
                        ...
                        <li className="col">
                          <Link to="salaryslip.html" className="d-flex color-700">
                            <div className="avatar">
                              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24">
                                <path xmlns="http://www.w3.org/2000/svg" d="M20,20c0,1.104-0.896,2-2,2H6c-1.104,0-2-0.896-2-2V4c0-1.104,0.896-2,2-2h8l6,6V20z" style={{fill: 'var(--primary-color)'}} data-st="fill:var(--chart-color4);" />
                                <path xmlns="http://www.w3.org/2000/svg" className="st0" d="M16,8c-1.1,0-1.99-0.9-1.99-2L14,2H6C4.9,2,4,2.9,4,4v16c0,1.1,0.9,2,2,2h1v-1.25C7,19.09,10.33,18,12,18  s5,1.09,5,2.75V22h1c1.1,0,2-0.9,2-2V8H16z M12,17c-1.66,0-3-1.34-3-3s1.34-3,3-3s3,1.34,3,3S13.66,17,12,17z" />
                              </svg>
                            </div>
                            <div className="flex-fill text-truncate">
                        ...
                        <li className="col">
                          <Link to="expenses.html" className="d-flex color-700">
                            <div className="avatar">
                              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 38 38">
                                <circle xmlns="http://www.w3.org/2000/svg" className="stshockcolor" cx={19} cy={19} r={11} style={{fill: 'var(--primary-color)'}} data-st="fill:var(--chart-color4);" />
                        ...
                        <li className="col">
                          <Link to="ui-elements/stater-page.html" className="d-flex color-700">
                            <div className="avatar">
                              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24">
                                <rect xmlns="http://www.w3.org/2000/svg" width={24} height={24} style={{fill: 'none'}} fill="none" />
                                <path xmlns="http://www.w3.org/2000/svg" d="M20,20c0,1.104-0.896,2-2,2H6c-1.104,0-2-0.896-2-2V4c0-1.104,0.896-2,2-2h8l6,6V20z" style={{fill: 'var(--primary-color)'}} data-st="fill:var(--chart-color4);" />
                                <path xmlns="http://www.w3.org/2000/svg" className="st0" d="M11,13h2v2h-2V13z M20,8v12c0,1.1-0.9,2-2,2H6c-1.1,0-2-0.9-2-2V4c0-1.1,0.9-2,2-2h8l0.01,4  c0,1.1,0.891,2,1.99,2H20z M17,11h-2V9h-2v2h-2V9H9v2H7v2h2v2H7v2h2v2h2v-2h2v2h2v-2h2v-2h-2v-2h2V11z" />
                              </svg>
                            </div>
                            <div className="flex-fill text-truncate">
                        ...
                        <li className="col">
                          <Link to="ui-elements/documentation.html" className="d-flex color-700">
                            <div className="avatar">
                              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 32 32">
                                <path xmlns="http://www.w3.org/2000/svg" d="M25.5,9.78V28.5c0,0.56-0.44,1-1,1h-17c-0.56,0-1-0.44-1-1v-25c0-0.55,0.45-1,1-1h10.72  L25.5,9.78z" style={{fill: 'var(--primary-color)'}} data-st="fill:var(--chart-color4);" />
                                <path xmlns="http://www.w3.org/2000/svg" className="st0" d="M19.5,9.5c-0.561,0-1-0.439-1-1V2.793L25.207,9.5H19.5z" />
                        ...
                        <li className="col">
                          <Link to="ui-elements/changelog.html" className="d-flex color-700">
                            <div className="avatar">
                              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24">
                                <rect xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" />
                                <polygon xmlns="http://www.w3.org/2000/svg" className="st0" points="22,6 22,12 20,12 20,9.42 13,16.41 8.95,12.36 2.65,17.76 1.35,16.24 9.05,9.64   13,13.59 18.58,8 16,8 16,6 " />
                                <polygon xmlns="http://www.w3.org/2000/svg" className="st1" points="11.91,12.5 10.58,13.99 8.95,12.36 2.65,17.76 1.35,16.24 9.05,9.64 " />
                              </svg>
                            </div>
                            <div className="flex-fill text-truncate">
